  ...
  return (
    <ContainerSections>
      <footer className="w-full max-w-7xl flex flex-col items-center justify-center gap-5 px-6 pt-10 pb-6 rounded-t-3xl bg-gradient-to-b from-[#001f3f] to-[#000]">
        <h2 className="text-white text-3xl font-bold neon-glow">TOTAL PRIVACY</h2>

        <p className="text-sm text-gray-200">©2025 All rights reserved by Total Privacy.</p>
