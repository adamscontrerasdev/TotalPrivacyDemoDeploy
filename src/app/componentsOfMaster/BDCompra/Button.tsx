    ...
    <>
      {!modal ? (
        <div className={style.container}>
          ...
          />
          <div
            className={`transition-all duration-200 overflow-hidden w-[70vw] md:w-[20vw] relative flex flex-col items-center justify-center gap-10 md:gap-16`}
            style={{
        ...
        <div className="">
          <ReusableButton
            ...
            color="#fff"
            bg={"#00f"}
            className={` ${isPressed ? style.buttonPressed : ""}`}
            onClick={() => {
